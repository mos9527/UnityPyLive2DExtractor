...
def process_namespace(namespace: str, typetree_defs: dict, f: TextIOWrapper):
    pass
...
def __main__():
    ...
    # In Python, Module would be a good analogy
    typetree_defs = {k.split(".")[-1]: v for k, v in TYPETREE_DEFS.items()}
